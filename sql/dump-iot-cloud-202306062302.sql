...
CREATE TABLE `device_type_attribute_modbus` (
  ...
  `data_type` int NOT NULL DEFAULT '1' COMMENT '数据类型 0 位 1 16位无符号整数 2 16位有符号整数 3 32位无符号整数 4 32位有符号整数',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='设备类型属性Modbus表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `device_type_attribute_modbus` VALUES (1,18,1,1,1,1,1),(2,18,2,1,2,1,1),(3,18,3,1,3,1,1),(4,18,4,1,4,1,1),(5,18,5,1,5,1,1),(6,18,6,1,6,1,1),(7,18,7,1,7,1,1),(8,18,8,1,8,1,1),(11,18,7,1,1,1,1),(12,18,7,1,1,1,1),(13,18,7,1,1,1,1),(14,18,5,6,5,2,3),(15,18,7,1,1,1,1),(16,18,6,1,1,1,1),(17,18,7,1,1,1,1),(18,18,7,1,1,1,1),(19,18,7,1,1,1,1),(20,18,7,4,1,1,1),(21,18,7,4,1,2,1),(22,18,7,4,1,2,2);
...
-- Dump completed on 2023-06-06 23:02:09
