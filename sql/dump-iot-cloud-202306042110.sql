...
INSERT INTO `device_info` VALUES (1,1,1,'1','1','1',0,1,0),(2,7,5,'a','A8cMLum','L6uD9h',1,2,0),(3,7,5,'b','63rmv5QKw','ifwAs5',2,2,1),(4,7,5,'d','TEmyXLpd','RVVikRnMw',1,2,2),(5,7,5,'d','JRQZT8Eh','Hd6BL9nk',2,2,3),(6,7,5,'fd','R433WJ9In','pzHOSnKdt',0,2,4),(7,7,5,'fsf','fKLVh5J','AXFQrM',0,2,0),(8,7,5,'1','JZQEMp6d','qYZepsz',0,2,0),(9,7,5,'sfs','RvEGGe','L9QpYwy',0,2,0),(10,7,5,'fsf方式','IA4ri4','L9MHkHhP',0,2,0),(11,7,5,'发生发射点','0Efi6i','cN3d3sJwX',0,2,0),(12,7,5,'fsdfs','4YlFO9be','3W2bKR',0,2,0),(13,7,5,'dfs','WgqbNDM','d4tnDnOS',0,4,0),(14,7,5,'fsdf','MTlWEIg','ppPcNv',0,3,0),(15,7,5,'fs','TQdGwQi','vi0v9H1z',0,4,0),(16,7,5,'fs','DPAfDDXq','hoWhCATXK',0,3,0),(17,7,5,'fs','D9sctHBJ','4vMS0BK',0,3,0),(18,7,5,'fs','XoVnVQ2','YXOsHbV',0,3,0),(19,7,5,'fs','ZHP07YI','1SOt6cv',0,3,0);
...
CREATE TABLE `device_type` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='设备类型表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `device_type` VALUES (17,'aa',1,101,1,101,5,0,'\0'),(18,'bb',1,101,2,201,5,10,'s');
...
INSERT INTO `device_type_attribute_modbus` VALUES (1,7,1,1,1,1,1),(2,7,2,1,2,1,1),(3,7,3,1,3,1,1),(4,7,4,1,4,1,1),(5,7,5,1,5,1,1),(6,7,6,1,6,1,1),(7,7,7,1,7,1,1),(8,7,8,1,8,1,1);
...
CREATE TABLE `history_device_online` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='历史数据-设备上下线';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-06-04 21:10:37
